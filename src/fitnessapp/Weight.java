...
public class Weight extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("How much do you weight?");

        jTextField1.setFont(new java.awt.Font("Tw Cen MT Condensed", 1, 30)); // NOI18N
        jTextField1.setForeground(new java.awt.Color(4, 4, 101));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try
        {
            ...
            if(Double.parseDouble(jTextField1.getText()) >= 35 && Double.parseDouble(jTextField1.getText()) <= 400)
            {
                BMI.setKg(Double.parseDouble(jTextField1.getText()));
                What w = new What();
                w.show();
                dispose();
            }
